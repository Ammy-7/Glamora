...
{{session('error')}}</div>
    ...
    @endif
    <h1 class="text-center mt-4" style="font-variant:small-caps;">add product</h1>
    <div class="container">
        <div class="row">
            <div class="col-4">
        </div>
        <div class="col-4">
            <form action="{{route('insert-pro')}}" method="post" enctype="multipart/form-data">
                @csrf
<input class="form-control mt-4" type="text" placeholder="Enter name" name="pro_name">
@error('pro_name')
...
<input class="form-control mt-4" type="text" placeholder="Enter Price" name="price">
@error('price')
  <p style="font-variant: small-caps; color:red; font-weight:500">{{$message}}</p>
    
@enderror
<input class="form-control mt-4" type="number" placeholder="Enter Quantity" name="quantity">
@error('quantity')
  <p style="font-variant: small-caps; color:red; font-weight:500">{{$message}}</p>
