					...
					<div class="row">
						<div class="col-lg-3 thumbnails_col order-lg-1 order-2">
							<div class="single_product_thumbnails">
								<ul>
									<li><img src="user/images/single_1_thumb.jpg" alt="" data-image="user/images/single_1.jpg"></li>
									<li class="active"><img src="user/images/single_2_thumb.jpg" alt="" data-image="user/images/single_2.jpg"></li>
									<li><img src="user/images/single_3_thumb.jpg" alt="" data-image="user/images/single_3.jpg"></li>
								</ul>
							</div>
						</div>
						<div class="col-lg-9 image_col order-lg-2 order-1">
							<div class="single_product_image">
								<div class="single_product_image_background" style="background-image:url(user/images/single_2.jpg)"></div>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="col-lg-5">
				<div class="product_details">
					...
					<div class="quantity d-flex flex-column flex-sm-row align-items-sm-center">
						...
						<div class="red_button add_to_cart_button"><a href="{{route('add-product')}}">add to cart</a></div>
					...
					<div id="tab_1" class="tab_container active">
						<div class="row">
							<div class="col-lg-5 desc_col">
								...
								<div class="tab_image">
									<img src="user/images/desc_1.jpg" alt="">
								</div>
								<div class="tab_text_block">
									<h2>Pocket cotton sweatshirt</h2>
									<p>Nam tempus turpis at metus scelerisque placerat nulla deumantos solicitud felis. Pellentesque diam dolor, elementum etos lobortis des mollis ut...</p>
							...
							<div class="col-lg-5 offset-lg-2 desc_col">
								<div class="tab_image">
									<img src="user/images/desc_2.jpg" alt="">
								</div>
								<div class="tab_text_block">
									<h2>Pocket cotton sweatshirt</h2>
									<p>Nam tempus turpis at metus scelerisque placerat nulla deumantos solicitud felis. Pellentesque diam dolor, elementum etos lobortis des mollis ut...</p>
								...
								<div class="tab_image desc_last">
									<img src="user/images/desc_3.jpg" alt="">
								</div>
							</div>
						</div>
					</div>
