...
<body>
   <div class="container">
    ...
    <div class="row">
<form action="{{route('R_Data')}}" method="post" >
    @csrf

    <input type="text" placeholder="Enter Your Name" name="name" class="form-control mt-3 rounded-3" value="{{old('name')}}">
    @error('name')
 ...
 <p style="font-variant: small-caps; color:red; font-weight:500">{{$message}}</p>
    ...
    @enderror
<button class="btn btn-warning mt-4 rounded-3" style="font-variant: small-caps; font-weight:bold;">submit</button>
